     ...
     if(prevState.current==null){
      set_current_element(localStorage.getItem('myState'));
          ...
          if (prevState.current) {
              ...
              document.getElementById(prevState.current).style.opacity = '70%';
              ...
              document.getElementById(prevState.current).style.backgroundColor = 'white';
          }
        ...
        if (prevState.current) {
          ...
          document.getElementById(current_element).style.backgroundColor = '#EEF5FF';
